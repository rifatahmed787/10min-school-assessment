...
const TextInput = ({
  ...
  return (
    <div className="flex flex-col gap-2 relative">
      ...
      <input
        id={id || "input-box"}
        className={cn("block py-2 px-0 w-full text-base bg-transparent border-2 border-primary appearance-none rounded-md focus:outline-none focus:ring-0 text-black font-secondary focus:border-primary peer focus:border-t-1 pl-2", className)}
        type={inputType}
        value={currentValue}
